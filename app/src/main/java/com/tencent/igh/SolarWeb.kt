...
import com.tencent.igh.Glo.Companion.lknfr
import com.tencent.igh.databinding.ActivitySolarWebBinding
import org.json.JSONException
import org.json.JSONObject
import java.io.File
import java.io.IOException

class SolarWeb : AppCompatActivity() {
    ...
    lateinit var bind: ActivitySolarWebBinding

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        bind = ActivitySolarWebBinding.inflate(layoutInflater)
...
// Setting External User Id with Callback Available in SDK Version 4.0.0+
    ...
    private fun getUrl(): String {
        ...
        val cpOne: String? = sharPref.getString(G1, "null")
        val dpOne: String? = sharPref.getString(H1, "null")
        val mainid: String? = sharPref.getString(lknfr, null)

        val pack = "com.tencent.igh"
        ...
        val first = "http://"
        val second = "solaraurora.xyz/go.php?to=2&"
